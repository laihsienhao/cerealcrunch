...
A binary AI-generated-image classifier (<2B params) that detects synthetic images on both clean images as well as images under 6 real-world post-processing transforms (JPEG compression, Gaussian blur, resize, Gaussian noise, color jitter, center crop).
...
Run the robustness evaluation (clean + all 14 image transforms) and the required prediction CLI:
